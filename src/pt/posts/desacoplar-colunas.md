...
No que toca ao desacoplamento, nem todos os materiais são iguais. Um erro comum no mundo DIY é que qualquer material mole serve para isolar uma coluna. Isto leva as pessoas a usar produtos como bolas de ténis cortadas em dois, espuma de embalagem normal ou até placas de lã de rocha de alta densidade. Estes são geralmente ineficazes e não constituem materiais com propriedades de mola.
...
#### Image 1. Três exemplos de diferentes apoios Sylomer e suportes de mola da <a href="https://www.mecanocaucho.com" target="_blank" rel="noopener noreferrer">AMC Mecanocaucho</a>.
...
Para resolver isto, é preciso calcular a carga por ponto de montagem. Quando se usa materiais tipo Sylomer ou Regufoam, os fabricantes fornecem fichas técnicas especificando a gama de carga estática ideal para cada densidade codificada por cores. Por exemplo, um apoio verde pode funcionar melhor entre 5-10kg, enquanto um amarelo requer 15-30kg para funcionar como pretendido. Pode ser necessário usar densidades diferentes para a frente e para trás, ou ajustar o espaçamento dos apoios para equilibrar a distribuição de peso.
...
#### Image 3. A medir a deflexão em apoios Sylomer individuais com a inigualável régua do <a href="https://www.youtube.com/@arduinoversusevil2025" target="_blank" rel="noopener noreferrer">@AvE</a> para garantir a carga correta.